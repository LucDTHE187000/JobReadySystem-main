        ...
        <SeekerLayout breadcrumb="Activity Hub › Chấm CV" title={showAnalysis ? '' : 'Chấm & phân tích CV'}>
            {!showAnalysis && (
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 -mt-4">
                    <p className="text-[#5A6482]">Phân tích ATS, kỹ năng và mở khóa luyện phỏng vấn AI (500 credit/lần)</p>
                    
                    {/* Tabs Selector */}
                    <div className="flex bg-gray-100 p-1 rounded-xl border border-gray-200 self-start sm:self-auto shadow-sm">
                        <button
                    ...
                    <>
                        ...
                        {!loading && cvs.length === 0 && (
                            <div className="text-center py-12 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300">
                                ...
                                <p className="text-sm text-gray-500 mt-2">Tải lên CV từ phần trên hoặc chuyển sang tab "Tự thiết kế CV" để bắt đầu</p>
                            </div>
                        )}
                    </>
                )}
                ...
                {activeTab === 'builder' && (
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            {/* Personal Info */}
                            <div className="bg-white rounded-2xl shadow-md p-6 border border-[#DDE3F0]">
                                <h3 className="text-lg font-bold text-[#0A2463] mb-4 border-b pb-2 flex items-center gap-2">
                                    <span className="p-1 rounded-lg bg-blue-50 text-[#0A2463]">👤</span>
                                    Thông tin cá nhân
                                </h3>
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 text-sm rounded-lg border border-[#DDE3F0] outline-none focus:ring-2 focus:ring-[#0A2463]"
                                            placeholder="Nguyễn Văn A"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Vị trí ứng tuyển</label>
                                        <input
                                            type="text"
                                            value={cvForm.title}
                                    ...
                                    <div className="md:col-span-2">
                                        <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Địa chỉ</label>
                                        <input
                                            type="text"
                            ...
                            <div className="bg-white rounded-2xl shadow-md p-6 border border-[#DDE3F0]">
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full px-3 py-2 text-sm rounded-lg border border-[#DDE3F0] outline-none focus:ring-2 focus:ring-[#0A2463] resize-none"
                            ...
                            <div className="bg-white rounded-2xl shadow-md p-6 border border-[#DDE3F0]">
                                <div className="flex justify-between items-center mb-4 border-b pb-2">
                                    <h3 className="text-lg font-bold text-[#0A2463] flex items-center gap-2">
                                        <span className="p-1 rounded-lg bg-blue-50 text-[#0A2463]">💼</span>
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-1.5 bg-blue-50 text-[#0A2463] hover:bg-blue-100 text-xs font-semibold rounded-lg transition"
                                    >
                                        + Thêm kinh nghiệm
                                    </button>
                                </div>
                                <div className="space-y-6">
                                    {cvForm.experience.map((exp, index) => (
                                        <div key={index} className="p-4 rounded-xl border border-gray-100 bg-gray-50 relative">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Tên công ty</label>
                                                    <input
                                                        type="text"
                                                        value={exp.company}
                                                        onChange={(e) => handleExperienceChange(index, 'company', e.target.value)}
                                                        className="w-full px-3 py-2 text-sm rounded-lg border border-[#DDE3F0] bg-white outline-none focus:ring-2 focus:ring-[#0A2463]"
                                                        placeholder="Google, FPT..."
                                                    />
                                                </div>
                                                <div>
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Vị trí/Chức danh</label>
                                                    <input
                                                        type="text"
                                                        value={exp.role}
                                                ...
                                                <div className="md:col-span-2">
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Khoảng thời gian</label>
                                                    <input
                                                        type="text"
                                                        value={exp.duration}
                                                ...
                                                <div className="md:col-span-2">
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Mô tả công việc</label>
                                                    <textarea
                                                        value={exp.desc}
                                                        onChange={(e) => handleExperienceChange(index, 'desc', e.target.value)}
                                                        rows={3}
                                                        className="w-full px-3 py-2 text-sm rounded-lg border border-[#DDE3F0] bg-white outline-none focus:ring-2 focus:ring-[#0A2463] resize-none"
                                ...
                                <div className="space-y-6">
                                    {cvForm.education.map((edu, index) => (
                                        <div key={index} className="p-4 rounded-xl border border-gray-100 bg-gray-50 relative">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Tên trường học</label>
                                                    <input
                                                        type="text"
                                                        value={edu.school}
                                                ...
                                                <div>
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Chuyên ngành</label>
                                                    <input
                                                        type="text"
                                                        value={edu.major}
                                                ...
                                                <div className="md:col-span-2">
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Mô tả bổ sung (Tùy chọn)</label>
                                                    <input
                                                        type="text"
                                                        value={edu.desc}
                            ...
                            <div className="bg-white rounded-2xl shadow-md p-6 border border-[#DDE3F0]">
                                <h3 className="text-lg font-bold text-[#0A2463] mb-4 border-b pb-2 flex items-center gap-2">
                                    <span className="p-1 rounded-lg bg-blue-50 text-[#0A2463]">🛠️</span>
                                    Kỹ năng chuyên môn
                                </h3>
                                <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase font-semibold text-gray-700">Danh sách kỹ năng (ngăn cách bằng dấu phẩy)</label>
                                <input
                                    type="text"
                                    value={cvForm.skills}
                                ...
                                <div className="space-y-6">
                                    {cvForm.projects.map((p, index) => (
                                        <div key={index} className="p-4 rounded-xl border border-gray-100 bg-gray-50 relative">
                                            ...
                                            <div className="grid gap-4">
                                                <div>
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Tên dự án</label>
                                                    <input
                                                        type="text"
                                                        value={p.name}
                                                ...
                                                <div>
                                                    <label className="block text-xs font-semibold text-gray-500 mb-1 uppercase">Mô tả dự án</label>
                                                    <textarea
                                                        value={p.desc}

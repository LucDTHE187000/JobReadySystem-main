    ...
    return (
        <div className="flex items-center gap-0 mt-4 w-full">
            {STEPS.map((step, i) => {
                ...
                const stepColor = isRejected && i === activeStep ? 'bg-red-500 border-red-500' : done ? 'bg-[#0A2463] border-[#0A2463]' : 'bg-white border-gray-300';
                const textColor = active ? (isRejected ? 'text-red-600 font-semibold' : 'text-[#0A2463] font-semibold') : done ? 'text-[#1A3A7C] font-medium' : 'text-gray-400';
...
function ApplicationCard({ app }) {
    ...
    return (
        <div className="bg-white rounded-2xl border border-[#DDE3F0] shadow-sm p-5 hover:shadow-md hover:border-[#0A2463]/30 transition-all">
                        ...
                        <div className="flex gap-3">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 py-2.5 bg-white border border-[#DDE3F0] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#0A2463]"
                                />
                            </div>
                        </div>

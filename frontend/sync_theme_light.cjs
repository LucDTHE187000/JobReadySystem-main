...
// -------------------------------------------------------------
// 13. InterviewAnalytics.jsx
// -------------------------------------------------------------
updateFile('src/pages/InterviewAnalytics.jsx', [
  // ScoreCard highlight states
  { target: "highlight\n                    ? 'bg-[#F5C518]/25 border-[#F5C518]/30 text-white'\n                    : 'bg-white/10 border-white/10 backdrop-blur-md text-white shadow-xl'", replacement: "highlight\n                    ? 'bg-[#F5C518]/15 border-[#F5C518]/35 text-slate-800 shadow-md'\n                    : 'bg-white/80 border border-slate-200/60 backdrop-blur-md text-slate-800 shadow-md'" },
  { target: "highlight ? 'text-white/80' : 'text-white/60'", replacement: "highlight ? 'text-slate-700' : 'text-slate-500'" },
  { target: "highlight ? 'text-[#F5C518] font-bold font-bold' : 'text-white'", replacement: "highlight ? 'text-[#0A2463] font-bold' : 'text-[#0A2463]'" },
  { target: "highlight ? 'text-white/50' : 'text-white/60'", replacement: "highlight ? 'text-slate-500' : 'text-slate-550'" },
  { target: "highlight ? 'bg-white/20' : 'bg-white/10'", replacement: "highlight ? 'bg-slate-200' : 'bg-slate-100'" },
  { target: "highlight ? 'bg-[#F5C518]' : 'bg-gradient-to-r from-[#F5C518] to-emerald-400'", replacement: "highlight ? 'bg-[#0A2463]' : 'bg-gradient-to-r from-[#0A2463] to-emerald-500'" },
  // Description and general texts
  { target: 'text-white/60 mb-8 -mt-2', replacement: 'text-slate-500 mb-8 -mt-2' },
  { target: 'text-white/60 mb-6 -mt-2', replacement: 'text-slate-500 mb-6 -mt-2' },
  { target: 'text-white/60 ml-4', replacement: 'text-slate-500 ml-4' },
  // stat cards
  { target: 'bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl p-4 text-white shadow-xl', replacement: 'bg-white/80 border border-slate-200/60 backdrop-blur-md rounded-2xl p-4 text-slate-800 shadow-md' },
  { target: 'text-xs font-semibold text-white/60', replacement: 'text-xs font-semibold text-slate-500' },
  { target: 'text-white', replacement: 'text-slate-800' },
  { target: 'text-[#F5C518] mx-auto mb-4', replacement: 'text-[#0A2463] mx-auto mb-4' },
  { target: 'text-emerald-400', replacement: 'text-emerald-600' },
  // category scores
  { target: 'bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl p-8 text-white shadow-xl mb-8', replacement: 'bg-white/80 border border-slate-200/60 backdrop-blur-md rounded-2xl p-8 text-slate-800 shadow-md mb-8' },
  { target: 'font-semibold text-white', replacement: 'font-semibold text-slate-700' },
  { target: 'font-bold text-[#F5C518]', replacement: 'font-bold text-[#0A2463]' },
  { target: 'w-full bg-white/10 rounded-full h-3 border border-white/5', replacement: 'w-full bg-slate-100 rounded-full h-3 border border-slate-200' },
  { target: 'h-3 rounded-full bg-gradient-to-r from-[#F5C518] to-emerald-400 transition-all', replacement: 'h-3 rounded-full bg-gradient-to-r from-[#0A2463] to-emerald-500 transition-all' },
  // Strengths and Improvements cards
  { target: 'bg-white/10 border border-white/10 border-l-4 border-l-emerald-400 backdrop-blur-md rounded-2xl p-8 text-white', replacement: 'bg-white/80 border border-slate-200/60 border-l-4 border-l-emerald-500 backdrop-blur-md rounded-2xl p-8 text-slate-800 shadow-md' },
  { target: 'bg-white/10 border border-white/10 border-l-4 border-l-[#F5C518] backdrop-blur-md rounded-2xl p-8 text-white', replacement: 'bg-white/80 border border-slate-200/60 border-l-4 border-l-[#F5C518] backdrop-blur-md rounded-2xl p-8 text-slate-800 shadow-md' },
  { target: 'text-emerald-400', replacement: 'text-emerald-600' },
  { target: 'text-white/60', replacement: 'text-slate-500' },
  // AI Recommendations
  { target: "rec.priority === 'high'\n                                            ? 'bg-red-500/10 border border-red-500/20 text-red-300'\n                                            : rec.priority === 'medium'\n                                            ? 'bg-[#F5C518]/10 border border-[#F5C518]/20 text-[#F5C518] font-bold'\n                                            : 'bg-white/5 border border-white/10 text-white/80'", replacement: "rec.priority === 'high'\n                                            ? 'bg-red-50 border border-red-200 text-red-700 font-semibold'\n                                            : rec.priority === 'medium'\n                                            ? 'bg-amber-50 border border-amber-200 text-amber-800 font-semibold'\n                                            : 'bg-slate-50 border border-slate-200 text-slate-700'" },
  { target: 'text-white/60 text-sm', replacement: 'text-slate-600 text-sm' },
  // Time stats
  { target: 'bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl p-8 text-white mb-8 shadow-xl', replacement: 'bg-white/80 border border-slate-200/60 backdrop-blur-md rounded-2xl p-8 text-slate-800 shadow-md mb-8' }
]);
